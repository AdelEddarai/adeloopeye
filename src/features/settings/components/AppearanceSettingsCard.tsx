    ...
    <Card className="border-[var(--bd)] bg-[var(--bg-1)] py-0 shadow-none">
      <CardHeader className="border-b border-[var(--bd)] px-5 py-4">
        ...
        <CardDescription className="text-[var(--t3)]">
          Customize the visual appearance and scale of the interface.
        </CardDescription>
      </CardHeader>
      <CardContent className="flex flex-col gap-6 px-5 py-5">
        <div className="flex flex-col gap-2">
          <span className="text-xs font-semibold uppercase tracking-[0.08em] text-[var(--t4)]">Theme</span>
          <Select
            value={prefs.theme}
            disabled={!canPersistPreferences}
            onValueChange={value => patchAppearancePrefs({ theme: value as Theme })}
          >
            ...
            <SelectContent className="border-[var(--bd)] bg-[var(--bg-1)] text-[var(--t1)]">
              <SelectItem className="focus:bg-[var(--bg-3)] focus:text-[var(--t1)]" value="light">Light</SelectItem>
              <SelectItem className="focus:bg-[var(--bg-3)] focus:text-[var(--t1)]" value="dark">Dark</SelectItem>
              <SelectItem className="focus:bg-[var(--bg-3)] focus:text-[var(--t1)]" value="system">System</SelectItem>
            </SelectContent>
          </Select>
        ...
        {!canPersistPreferences && (
          <p className="text-xs text-[var(--warning)]">
            Preference storage is currently unavailable, so changes are disabled.
          </p>
        )}
      </CardContent>
    </Card>
