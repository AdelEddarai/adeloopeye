...
// Sub-components shared by AdeloopeyeView
...
type AdeloopeyeNoteProps = { note: string };

export function AdeloopeyeNote({ note }: AdeloopeyeNoteProps) {
  ...
  return (
    ...
    >
      <div className="flex gap-[7px] items-start">
        ...
        <div>
          <div className="label mb-0.5">Adeloopeye Analyst Note</div>
