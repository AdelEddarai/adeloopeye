...
export const MOROCCO_LOCATIONS: Record<string, LocationCoordinates> = {
  ...
  'Laayoune': { lat: 27.1536, lng: -13.1994, zoom: 11 },
  'Dakhla': { lat: 23.7158, lng: -15.9582, zoom: 11 },
  'Al Hoceima': { lat: 35.2517, lng: -3.9317, zoom: 11 },
  'Chefchaouen': { lat: 35.1686, lng: -5.2686, zoom: 11 },
  'Ifrane': { lat: 33.5228, lng: -5.1106, zoom: 11 },
  'Azrou': { lat: 33.4344, lng: -5.2222, zoom: 11 },
  'Midelt': { lat: 32.6800, lng: -4.7372, zoom: 11 },
  'Zagora': { lat: 30.3297, lng: -5.8372, zoom: 11 },
  'Tinghir': { lat: 31.5147, lng: -5.5328, zoom: 11 },
  'Sefrou': { lat: 33.8306, lng: -4.8292, zoom: 11 },
  'Tiflet': { lat: 33.8978, lng: -6.3167, zoom: 11 },
  'Taroudant': { lat: 30.4728, lng: -8.8778, zoom: 11 },
  'Tiznit': { lat: 29.6974, lng: -9.7316, zoom: 11 },
  'Tan-Tan': { lat: 28.4378, lng: -11.1031, zoom: 11 },
  'Sidi Kacem': { lat: 34.2214, lng: -5.7089, zoom: 11 },
  'Sidi Slimane': { lat: 34.2642, lng: -5.9264, zoom: 11 },
  'Sidi Bennour': { lat: 32.6497, lng: -8.4278, zoom: 11 },
  'Youssoufia': { lat: 32.2453, lng: -8.5297, zoom: 11 },
  'Bouarfa': { lat: 32.5194, lng: -1.9628, zoom: 11 },
  'Figuig': { lat: 32.1089, lng: -1.2289, zoom: 11 },
  'Berkane': { lat: 34.9200, lng: -2.3200, zoom: 11 },
  'Taourirt': { lat: 34.4100, lng: -2.8900, zoom: 11 },
  'Khenifra': { lat: 32.9300, lng: -5.6600, zoom: 11 },
  'Smara': { lat: 26.7400, lng: -11.6700, zoom: 11 },
  'Boujdour': { lat: 26.1200, lng: -14.4800, zoom: 11 },
