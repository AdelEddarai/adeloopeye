...
export const COOKIE_CONSENT_STORAGE_KEY = 'adeloopeye:cookie-consent:v1';
export const BROWSE_ARTICLE_BANNER_STORAGE_KEY = 'adeloopeye:browse-article-banner-dismissed';
export const CHAT_VISITOR_COOKIE_NAME = 'adeloopeye_vid';
export const APPEARANCE_PREFS_STORAGE_KEY = 'adeloopeye:appearance:v1';
export const MAP_STORAGE_KEY = 'adeloopeye:map:v1';
export const NOTIFICATION_PREFS_STORAGE_KEY = 'adeloopeye:notifications:v1';
export const PANEL_LAYOUT_STORAGE_PREFIX = 'react-resizable-panels:';
export const WORKSPACE_STORAGE_KEY_V3 = 'adeloopeye:workspace:v3';
export const WORKSPACE_STORAGE_KEY_V4 = 'adeloopeye:workspace:v4';
...
export function isConsentRegion() {
  ...
  if (window.localStorage.getItem('adeloopeye:force-consent-region') === '1') {
    return true;
  }
